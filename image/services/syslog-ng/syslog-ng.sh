...
cp $SYSLOG_NG_BUILD_PATH/syslog-ng.init /etc/ucinit.d/10_syslog-ng.init
cp $SYSLOG_NG_BUILD_PATH/syslog-ng.shutdown /etc/ucinit.post_shutdown.d/10_syslog-ng.shutdown
