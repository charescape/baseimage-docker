...
cp $SYSLOG_NG_BUILD_PATH/syslog-ng.init /etc/uc_init.d/10_syslog-ng.init
cp $SYSLOG_NG_BUILD_PATH/syslog-ng.shutdown /etc/uc_init.post_shutdown.d/10_syslog-ng.shutdown
