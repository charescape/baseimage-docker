...
# Example overrides:
#   echo "ENV['PASSENGER_DOCKER_PATH'] ||= '../../charescape/passenger-docker'   " >> ~/.vagrant.d/Vagrantfile
#   echo "ENV['BASE_BOX_URL']          ||= 'd\:/dev/vm/vagrant/boxes/charescape/'" >> ~/.vagrant.d/Vagrantfile
BASE_BOX_URL          = ENV['BASE_BOX_URL']    || 'https://oss-binaries.charescapepassenger.com/vagrant/boxes/latest/'
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.box = 'charescape-open-ubuntu-14.04-amd64'
